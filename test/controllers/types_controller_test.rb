...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { description: @type.description, name: @type.name, user_id: @type.user_id } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { description: @type.description, name: @type.name, user_id: @type.user_id } }
